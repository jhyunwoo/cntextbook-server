...
This criterion is not without logic: study of the fundamentally unknowable is futile and should be avoided.
...
Large parts of social science have already diverted their focus from the important to the easily observed, thereby drifting into trivia.
...
So should he have restrained himself from devising it?
그러니 그가 그것을 고안하는 것을 스스로 제한해야 했을까?
The structure of a scientific program is distorted when researchers shy from the logical next question because its answer will be hard to find.
...
더 좋은 해결책은 관찰이 덜 가능한 것을 연구하는 더 어려운 과업을 떠맡는 학자들에게 추가적인 인정을 해 주는 것이 다.
