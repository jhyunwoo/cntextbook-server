...
const { year1MainPage } = require("./mainpage/list-v2-year1");
const { year2MainPage } = require("./mainpage/list-v2-year2");
...
app.get("/v2/y2/", version);
app.get("/v2/y1/mainpage", year1MainPage);
app.get("/v2/y2/mainpage", year2MainPage);
