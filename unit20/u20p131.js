...
그들은 일상적으로 데이터를 컴퓨터에 입력하거나 그것을 다시 가져오는데, 그것은 신용 카드 구매와 지불의 기록, 신용 보고서, 교환된 수표, 소비자 계좌, 소비자 편지, 급여 지불 명부, 병원비 계산서, 환자 기록, 의료비 청구, 법원 결정, 구독 자 명단, (직원) 총인원, 도서관 색인 목록 등이다.
...
‘정보 혁명’은 우리 중 몇몇을 더욱 생산적으로 바꿨을 수도 있지만, 그것은 또한 조립 라인의 노동자들이, 그리고 그들 이 전에는 직물 노동자들이, 다른 미가공 재료의 더미를 처리하던 것과 거의 같은 단조로운 방식으로 처리되어야 하는 거대한 미가공 데이터 의 무더기도 또한 만들어 냈다.
